...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 短信用户管理 <span class="c-gray en">&gt;</span> 短信用户 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
  ...
  <div class="cl pd-5 bg-1 bk-gray mt-20">
    ...
    <a href="javascript:;" onclick="addObj('550','','添加短信用户','/borrower/showAdd')" class="btn btn-primary radius"><i class="icon-plus"></i> 添加用户</a></span>
  ...
  <table class="table table-border table-bordered table-hover table-bg table-sort">
    ...
    <#list list as obj>
      <tr class="text-c">
        ...
        <td>${obj.name}</td>
        <td>${obj.phone}</td>
        <td>${obj.loanTime?string("yyyy-MM-dd HH:mm:ss")}</td>
        <td>${obj.repaymentTime?string("yyyy-MM-dd HH:mm:ss")}</td>
        <td class="f-14 user-manage"><a title="编辑" href="javascript:;" onclick="edit('4','550','','编辑','/borrower/showEdit')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a></td>
      </tr>
     </#list>
    </tbody>
  </table>
