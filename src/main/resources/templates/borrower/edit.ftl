...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${obj.name11}" placeholder="请输入紧联人姓名" name="name11" style="width:40%;">
				 紧联人手机1：
				<input type="text" class="input-text" value="${obj.phone11}" placeholder="请输入紧联人手机" name="phone11" style="width:40%;">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-3 col-sm-3">紧联人姓名2：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${obj.name12}" placeholder="请输入紧联人姓名" name="name12" style="width:40%;">
			 	紧联人手机2：
				<input type="text" class="input-text" value="${obj.phone12}" placeholder="请输入紧联人手机" name="phone12" style="width:40%;">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${obj.name22}" placeholder="请输入担保人姓名" name="name22" style="width:40%;">
				担保人手机2：
				<input type="text" class="input-text" value="${obj.phone22}" placeholder="请输入担保人手机" name="phone22" style="width:40%;">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-3 col-sm-3">担保人姓名3：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${obj.name23}" placeholder="请输入担保人姓名" name="name23" style="width:40%;">
				担保人手机3：
				<input type="text" class="input-text" value="${obj.phone23}" placeholder="请输入担保人手机" name="phone23" style="width:40%;">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-3 col-sm-3">备注：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="remark" cols="" rows="" class="textarea" placeholder="请输入备注">${obj.remark!}</textarea>
			</div>
		</div>
		<div class="row cl">
